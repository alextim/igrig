...
5. Отредактируйте и сохраните данные сайта на локальном компьютере: папка `[CONTENT_DIR]`.
6. Сохранение результатов редактирования в локальный репозиторий и оновление данных в удаленном.
   ...
   git push
   ```
7. Откройте папку проектом `[PROJECT_DIR]`
8. В окне Teminal выполните команды
   ```bush
...
Netlify отслеживает все изменения в удаленном репозитории проекта, автоматически cкомпилирует и опубликует обновленный сайт.
...
|---              |  ---:             |   ---:
| hero-480w.jpg   | 9 : 16            |  480 x  853
| hero-480w.webp  |                   |
| hero-1024.jpg   | 4 : 3             | 1024 x  768
| hero-1024.webp  |                   |
| hero-1920w.jpg  | 16 : 9            | 1920 x 1080
| hero-1920w.webp |                   |
...
Файлы надо поместить в папку `[PROJECT_DIR]/static/assets/images/hero/`.
