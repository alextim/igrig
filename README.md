...
| №  | Назначение  | Имя файла             | Папка                                     | Ш x В     | Размер, px                  | Количество
| ---|-----------  |---------------------- |-------------------------------            |---------- |-----------------------      | ------------
...
|  6 | webmainfest | icon.png              | ./src/assets/images                       | 1 x 1     | > 512 x 512                 | 1
|  7 | Hero        | hero-480w.jpg         | ./src/assets/images/hero                  | 9 x 16    |   480 x 853                 | 1
|  8 |             | hero-768w.jpg         |                                           | 9 x 16    |   768 x 136                 | 1
|  9 |             | hero-1024.jpg         |                                           | 4 x 3     |  1024 x 768                 | 1
| 10 |             | hero-1920w.jpg        |                                           | 16 x 9    |  1920 x 1080                | 1
...
Если в теле страницы (markdown) исходное изображение шириной меньше 796px, то оно выравнивается по центру с отступами по краям.
...
Папка: `[CONTENT_DIR]/photo-projects/osts`
